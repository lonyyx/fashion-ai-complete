...
export default async function handler(req, res) {
  ...
  if (req.method === 'GET') {
    try {
      ...
      if (query) {
        ...
        const products = await generateStrictProducts(aiAnalysis, query);
  ...
  if (req.method === 'POST') {
    try {
      ...
      const fallbackProducts = await generateStrictDemoProducts({ clothing_type: 'clothing', price_range: { max: 20000 } });
      const fallbackResponse = "Использую строгий поиск. Показываю только точные совпадения.";
...
async function generateStrictProducts(aiAnalysis, query) {
  ...
  return await generateStrictDemoProducts(aiAnalysis);
}
...
async function generateStrictDemoProducts(aiAnalysis) {
  const typeMap = {
    'shoes': [
      {
        id: 'demo_nike_airmax',
        ...
        oldPrice: 14990,
        image: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=300',
        link: 'https://www.nike.com/ru/t/air-max-270-mens-shoes-C1R8qN',
        store: 'Nike',
        storeColor: '#000000',
        rating: '4.7',
        reviews: 892,
      ...
      {
        id: 'demo_adidas_superstar',
        title: 'Кроссовки Adidas Superstar',
        price: 8990,
        oldPrice: 10990,
        image: 'https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=300',
        link: 'https://www.adidas.ru/superstar-shoes/EG4958.html',
        store: 'Adidas',
        storeColor: '#000000',
        rating: '4.6',
        reviews: 756,
    ...
    'jeans': [
      {
        id: 'demo_levis_512',
        title: 'Джинсы Levi\'s 512 Slim Taper',
        price: 5990,
        oldPrice: 6990,
        image: 'https://images.unsplash.com/photo-1542272604-787c3835535d?w=300',
        link: 'https://www.levi.com/RU/ru_RU/clothing/men/jeans/512-slim-taper-fit/p/285010000',
        store: 'Levi\'s',
        storeColor: '#0033a0',
        rating: '4.5',
        reviews: 634,
    ...
    't-shirt': [
      {
        id: 'demo_uniqlo_tshirt',
        title: 'Футболка Uniqlo U Cotton',
        price: 1290,
        oldPrice: 1590,
        image: 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=300',
        link: 'https://www.uniqlo.com/ru/ru/products/E449179-000/00',
    ...
    'jacket': [
      {
        id: 'demo_columbia_jacket',
        title: 'Куртка Columbia Powder',
        price: 12990,
        oldPrice: 15990,
        image: 'https://images.unsplash.com/photo-1551028719-00167b16eac5?w=300',
    ...
    'sweater': [
      {
        id: 'demo_cos_sweater',
        title: 'Свитер COS Wool',
        price: 5990,
        oldPrice: 7990,
        image: 'https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=300',
        link: 'https://www.cos.com/ru/ru_ru/',
        store: 'COS',
        storeColor: '#000000',
        rating: '4.5',
        reviews: 789,
    ...
    'pants': [
      {
        id: 'demo_uniqlo_pants',
        title: 'Брюки Uniqlo Smart',
        price: 3990,
        oldPrice: 4990,
  ...
  const demoProducts = typeMap[aiAnalysis.clothing_type] || [];
  
  const filteredDemos = demoProducts.filter(product => 
    product.price <= aiAnalysis.price_range.max
  );
  
  return filteredDemos.map(product => ({
    ...product,
    ai_generated: true,
    ai_relevance: 0.9
  }));
